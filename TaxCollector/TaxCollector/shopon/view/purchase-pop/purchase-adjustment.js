$.fn.purchaseAdjustment = function () {
    ...
    return $.pageController.getControl(this, function (page, $$) {
        ...
        page.template("/" + appConfig.root + "/shopon/view/purchase-pop/purchase-adjustment.html");
                ...
                page.controls.grdBill.setTemplate({
                    ...
                    columns: [
                      //  { 'name': "  ", 'width': "50px", 'dataField': "item_no", editable: false, itemTemplate: "<input type='button' class='grid-button' value='' action='Delete' style='background-image: url(https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-close-128.png);    background-size: contain;    background-color: transparent;    width: auto;background-repeat: no-repeat;    width: 23px;    border: none;    cursor: pointer;' />" },
                           { 'name': "Item No", 'width': "80px", 'dataField': "item_no" },
                           { 'name': "Bar Code", 'width': "150px", 'dataField': "barcode", visible: false },
                           { 'name': "Item Name", 'width': "230px", 'dataField': "item_name" },
                           { 'name': "In Stock", 'width': "100px", 'dataField': "qty_stock", visible: false },
                           { 'name': "", 'width': "0px", 'dataField': "qty", editable: false },
                           { 'name': "", 'width': "0px", 'dataField': "free_qty", editable: false, visible: false },
                           { 'name': "Qty", 'width': "70px", 'dataField': "temp_qty", editable: false },
                           { 'name': "", 'width': "0px", 'dataField': "adjustment_qty", editable: true },
                           { 'name': "Adjustment Qty", 'width': "120px", 'dataField': "temp_adjustment_qty", editable: true },
                           { 'name': "Free Qty", 'width': "100px", 'dataField': "temp_free_qty", editable: false, visible: CONTEXT.showFree },
                           { 'name': "Tray", 'width': "80px", 'dataField': "tray_received", editable: false, visible: CONTEXT.ENABLE_MODULE_TRAY },
                           //{ 'name': "Unit", 'width': "80px", 'dataField': "unit" },
                           { 'name': "Unit", 'width': "80px", 'dataField': "unit", itemTemplate: "<div  id='prdDetail' style=''></div>" },
                           { 'name': "Cost", 'width': "80px", 'dataField': "cost", editable: false },
                           { 'name': "Adjustment Cost", 'width': "130px", 'dataField': "adjustment_cost", editable: true },
                           { 'name': "Disc %", 'width': "80px", 'dataField': "disc_per", editable: false, visible: false },
                           { 'name': "Disc Value", 'width': "90px", 'dataField': "disc_val", editable: false, visible: false },
                           { 'name': "GST %", 'width': "70px", 'dataField': "tax_per", editable: false },
                           { 'name': "Net Rate", 'width': "100px", 'dataField': "net_rate", editable: false },
                           { 'name': "MRP", 'width': "70px", 'dataField': "mrp", editable: false, visible: CONTEXT.ENABLE_MRP },
                           { 'name': "Profit %", 'width': "120px", 'dataField': "profit", editable: false, visible: false },
                           { 'name': "Selling Rate", 'width': "120px", 'dataField': "selling_price", editable: false, visible: false },
                           { 'name': "Free Selling Rate", 'width': "150px", 'dataField': "free_selling_price", editable: false, visible: false },
                           { 'name': "Total", 'width': "90px", 'dataField': "total_price" },
                           { 'name': "Man Date", 'width': "100px", 'dataField': "man_date", editable: true, visible: false, },// itemTemplate: "<div  id='prdManDate' style=''></div>" },
                           { 'name': "Expiry Date", 'width': "120px", 'dataField': "expiry_date", editable: true, visible: false },
                           { 'name': "Manufacture Date", 'width': "260px", 'dataField': "temp_man_date", visible: false, itemTemplate: "<input type='date' dataField='temp_man_date'>" },
                           { 'name': "Expiry Date", 'width': "260px", 'dataField': "temp_expiry_date", visible: false, itemTemplate: "<input type='date' dataField='temp_expiry_date'>" },
                           { 'name': "Batch No", 'width': "100px", 'dataField': "batch_no", editable: true, visible: false },
                           { 'name': "Variation", 'width': "120px", 'dataField': "variation_name", editable: false, visible: CONTEXT.showVariation },
                           { 'name': "", 'width': "50px", 'dataField': "btn_variation_name", editable: false, visible: false, itemTemplate: "<input type='button' title='Open Bill'  class='grid-button' value='' action='New' style='    border: none;    background-color: transparent;    background-image: url(BackgroundImage/new-icon.png);    background-size: contain;    width: 25px;    height: 25px;margin-right:10px' />" },
                           { 'name': "Free Variation", 'width': "150px", 'dataField': "free_variation_name", visible: CONTEXT.enableFreeVariation && CONTEXT.showFree },
                           { 'name': "Buying Cost", '90px': "100px", 'dataField': "buying_cost" },
                           ...
                           { 'name': "", 'width': "0px", 'dataField': "var_cost", visible: false },
                           { 'name': "", 'width': "0px", 'dataField': "chk_new_var", visible: false },
                           { 'name': "", 'width': "0px", 'dataField': "chk_new_free_var", visible: false },
                           { 'name': "", 'width': "0px", 'dataField': "expiry_days", visible: false },
                           ...
                           { 'name': "", 'width': "0px", 'dataField': "man_date", editable: false, visible: false },// itemTemplate: "<div  id='prdManDate' style=''></div>" },
                           { 'name': "", 'width': "0px", 'dataField': "expiry_date", editable: false, visible: false },
                ...
                try {
                    ...
                    if (CONTEXT.ENABLE_MRP) {
                        if (parseFloat(billItem.mrp) < parseFloat(billItem.cost)) {
                            alert("MRP should not be less than the buying cost for item " + billItem.item_name + "");
                        }
                    }
                    ...
                    if (CONTEXT.ENABLE_MODULE_TRAY == true) {
                        if (billItem.tray_received == null || billItem.tray_received == "" || typeof billItem.tray_received == "undefined") {
                            billItem.tray_received = 0;
                        }
                        if (parseFloat(billItem.tray_received) < 0 || isNaN(billItem.tray_received))
        ...
        page.calculate = function (callback) {
            ...
            $(page.controls.grdBill.getAllRows()).each(function (i, row) {
                ...
                if (poItem.free_qty == "" || poItem.free_qty == null || poItem.free_qty == undefined)
                    poItem.free_qty = 0;
                if (poItem.adjustment_cost == "" || poItem.adjustment_cost == null || poItem.adjustment_cost == undefined)
                    poItem.adjustment_cost = 0;
                if (poItem.adjustment_qty == "" || poItem.adjustment_qty == null || poItem.adjustment_qty == undefined)
                    poItem.adjustment_qty = 0;
                
                temp_qty = parseFloat(poItem.qty) - parseFloat(poItem.adjustment_qty);
                ...
                var subtotal = (parseFloat(poItem.cost) * parseFloat(temp_qty)) + ((parseFloat(poItem.cost) + parseFloat(poItem.adjustment_cost)) * parseFloat(poItem.adjustment_qty));
                var discount = 0;
                ...
                //net_rate = parseFloat(parseFloat(total) / (parseFloat(poItem.qty))).toFixed(2);
            ...
            page.controls.lblDiscount.value(parseFloat(finaldiscount).toFixed(2));
            page.controls.lblTax.value(parseFloat(finaltax).toFixed(2));
                ...
                $(page.controls.grdBill.allData()).each(function (i, billItem) {
                    if (parseFloat(billItem.qty) > 0) {
                        rbillItems.push({
                            ...
                            price: parseFloat(billItem.adjustment_cost).toFixed(2),
                            ...
                            cost: parseFloat(billItem.buying_cost).toFixed(2),
                            ...
                            amount: parseFloat(billItem.adjustment_cost) * parseFloat(billItem.adjustment_qty)
                        });
                    }
                ...
                if (state == "New") {
                    ...
                    page.controls.grdBill.rowBound = function (row, item) {
                        ...
                        if (item.unit_identity == "1") {
                            ...
                            var temp_subtotal = parseFloat(item.cost) * parseFloat(item.qty);
                            var temp_discount = subtotal * parseFloat(item.disc_per) / 100 + (parseFloat(item.disc_val) * parseFloat(item.qty));
                            item.cost = (parseFloat(temp_subtotal) - parseFloat(temp_discount)) / parseFloat(item.temp_qty)
                        }
                        else {
                            item.temp_qty = parseFloat(item.qty);
                            var temp_subtotal = parseFloat(item.cost) * parseFloat(item.qty);
                            var temp_discount = temp_subtotal * parseFloat(item.disc_per) / 100 + (parseFloat(item.disc_val) * parseFloat(item.qty));
                            item.cost = (parseFloat(temp_subtotal) - parseFloat(temp_discount)) / parseFloat(item.temp_qty)
                        }
                        ...
                        row.on("change", "input[datafield=temp_adjustment_qty]", function () {
                            if ($(row).find("[id=itemUnit]").val() == "0") {
                                item.adjustment_qty = parseFloat(item.temp_adjustment_qty);
                            } else {
                                item.adjustment_qty = parseFloat(item.temp_adjustment_qty) * parseFloat(item.alter_unit_fact);
                            }
                            page.calculate();
                        });
                        row.on("change", "input[datafield=adjustment_cost]", function () {
                            page.calculate();
                        });
