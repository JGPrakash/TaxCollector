    ...
    return $.pageController.getPage(this, function (page, $$) {
        ...
        function PrintingOD(data) {
            ...
            $(data).each(function (i, item) {
                ...
                doc.write("<td  class='col' style=' width: 50px; height: 30px;border-left: 1px solid #dddddd;border-right: 1px solid #dddddd;'>" + parseFloat(tax_cgst).toFixed(5) + "</td>");
                doc.write("<td  class='col' style=' width: 50px; height: 30px;border-left: 1px solid #dddddd;border-right: 1px solid #dddddd;'>" + parseFloat(tax_sgst).toFixed(5) + "</td>");
            ...
            doc.write("<tr><td colspan='9' style=''><div> No.of.Items :  " + no_of_prd + "</div></td><td colspan='4'> <div ><b>SubTotal: </b><span style='float:right'>" + parseFloat(page.controls.lblSubTotal.value()).toFixed(5) + "</span> </div></td> </tr>");
            doc.write("<tr><td colspan='9' style=''><div> Quantity : " + tot_Qty + "</div></td><td colspan='4'> <div ><b>Discount Amount: </b><span style='float:right'>" + parseFloat(page.controls.lblTotalDiscounts.value()).toFixed(5) + "</span> </div></td> </tr>");
            ...
            doc.write("<tr><td colspan='9' style='border:0px'></td><td colspan='4'> <div ><b>Tax Amount: </b><span style='float:right'>" + parseFloat(page.controls.lblTotalTax.value()).toFixed(5) + " </span></div></td> </tr>");
        ...
        page.savePurchaseOrder = function (callback) {
            ...
            if (page.currentPO.state_text == "Created") {
                ...
                page.purchaseService.updatePO(newPO, function () {
                    var result = compareContents(page.currentPOItem, poItems, "po_no,item_no", "po_no,item_no,qty,tax_per,alter_unit_fact,unit_identity");
        ...
        page.calculate = function () {
            ...
            //txtAmount.html(parseFloat(qty_price).toFixed(5));
            ...
            var round_off = parseFloat(parseFloat(finaltotal) - parseFloat(total_after_Rnd_off)).toFixed(5);
            ...
            //page.controls.lblTotal.value(parseFloat(finaltotal).toFixed(5));
        ...
        page.view = {
            ...
            searchResult: function (data) {
                ...
                page.controls.grdPOResult.setTemplate({
                    ...
                    columns: [
                        ...
                        { 'name': "Amount", 'rlabel': 'Amount', 'width': "150px", 'dataField': "total_amount" },
                        { 'name': "Paid", 'rlabel': 'Paid', 'width': "100px", 'dataField': "total_paid_amount" },
            ...
            purchaseHistory: function () {
                ...
                page.dynaReportService.getPurchaseReport(repInput, function (data) {
                    ...
                    page.controls.lblTotalAmtPaid.html(isNaN(parseFloat(poSummary.tot_pay)) ? 0 : parseFloat(poSummary.tot_pay).toFixed(5));
            ...
            selectedPO: function (item) {
                if (item) {
                    ...
                    page.controls.lblTempPOBillNo.value(item.bill_id);
            ...
            selectedPOItems: function (data) {
                ...
                if (page.currentPO.state_text == "Created") {
                    ...
                    page.controls.grdPOItems.setTemplate({
                        ...
                        columns: [
                            ...
                            { 'name': "Cost", 'rlabel': "Cost", 'width': "70px", 'dataField': "cost" },
                            { 'name': "Disc %", 'rlabel': "Disc %", 'width': "70px", 'dataField': "disc_per" },
                            { 'name': "Disc Value", 'rlabel': "Disc Value", 'rlabel': "Unit", 'width': "80px", 'dataField': "disc_val" },
                            { 'name': "GST%", 'rlabel': "GST", 'width': "60px", 'dataField': "tax_per" },
                            { 'name': "Total", 'rlabel': "Total", 'width': "90px", 'dataField': "total_price" },
                            { 'name': "Net Rate", 'rlabel': "Net Rate", 'width': "100px", 'dataField': "net_rate", editable: false },
                            { 'name': "Buying Cost", 'rlabel': "Buying Cost", 'width': "90px", 'dataField': "buying_cost" },
                    ...
                    page.controls.grdPOItems.width("4000px");
                    page.controls.grdPOItems.height("auto");
                    page.controls.grdPOItems.setTemplate({
                        selection: "Single",
                        columns: [
                            ...
                            { 'name': "Profit %", 'rlabel': "Profit %", 'width': "120px", 'dataField': "profit", editable: page.currentPO.state_text == "Delivered" || page.currentPO.state_text == "Confirmed" },
                           ...
                           { 'name': "New" + CONTEXT.ALTER_PRICE_2_LABEL_NAME, 'rlabel': 'New Rate C', 'width': "120px", 'dataField': "alter_price_2", editable: true, visible: CONTEXT.ENABLE_ALTER_PRICE_2 },
                            ...
                            { 'name': "Variation", 'rlabel': 'Variation', 'width': "120px", 'dataField': "variation_name", editable: page.currentPO.state_text == "Confirmed" || page.currentPO.state_text == "Delivered", },// itemTemplate: "<select  id='variationGrid' style=''></select>" }, //itemTemplate: "<div id='variationGrid'></div>"},
                            ...
                            { 'name': "MRP", 'rlabel': 'MRP', 'width': "70px", 'dataField': "mrp", editable: true, visible: CONTEXT.ENABLE_MRP },
                            { 'name': "Manufacture Date", 'width': "0px", 'dataField': "man_date", editable: true, visible: false }, //page.currentPO.state_text == "Created", visible: CONTEXT.ENABLE_EXP_DATE },
                            { 'name': "Manufacture Date", 'rlabel': 'Man Date', 'width': "250px", 'dataField': "temp_man_date", visible: CONTEXT.ENABLE_MAN_DATE, itemTemplate: "<input type='date' dataField='temp_man_date'>" },
                            { 'name': "Expiry Date", 'width': "0px", 'dataField': "expiry_date", editable: true, visible: false }, //page.currentPO.state_text == "Created", visible: CONTEXT.ENABLE_EXP_DATE },
                            { 'name': "Expiry Date", 'rlabel': 'Exp Date', 'width': "250px", 'dataField': "temp_expiry_date", visible: CONTEXT.ENABLE_EXP_DATE, itemTemplate: "<input type='date' dataField='temp_expiry_date'>" },
                            { 'name': "Batch No", 'rlabel': 'Batch No', 'width': "80px", 'dataField': "batch_no", editable: true, visible: CONTEXT.ENABLE_BAT_NO },
                ...
                page.controls.grdPOItems.rowBound = function (row, item) {
                    ...
                    $(row).find("input[dataField=temp_man_date]").change(function () {
                        ...
                        item.man_date = dbDateTime(day + "-" + month + "-" + year);
                    ...
                    $(row).find("input[dataField=temp_expiry_date]").change(function () {
                        ...
                        item.expiry_date = dbDateTime(day + "-" + month + "-" + year);
                    ...
                    row.on("change", "input[datafield=selling_price]", function () {
                        ...
                        if (item.profit == "Infinity") {
                            item.profit = item.selling_price;
                            row.find("input[datafield=profit]").val(item.selling_price);
                        }
                    });
                    ...
                    if (page.stockMode) {
                        ...
                        if (CONTEXT.ENABLE_VARIATION_VENDOR_NO)
                            data1.vendor_no = page.controls.ddlPOVendor.selectedValue();
                        page.stockService.getVariationByCost(data1, function (data) {
                            if (data.length != 0) {
            ...
            selectedReturnPOItems: function (data) {
                ...
                $$("grdReturnPOItems").setTemplate({
                    ...
                    columns: [
                        ...
                        { 'name': "Ordered", 'rlabel': 'Ordered', 'width': "90px", 'dataField': "ordered_qty" },//, editable: false },
                        { 'name': "Cancelled", 'rlabel': 'Cancelled', 'width': "90px", 'dataField': "qty_returned" },//, editable: false },
                      ...
                      { 'name': "Variation", 'rlabel': 'Variation', 'width': "120px", 'dataField': "variation_name", },
                      { 'name': "Tax(%)", 'rlabel': 'GST', 'width': "120px", 'dataField': "tax_per", },
                        { 'name': "MRP", 'rlabel': 'MRP', 'width': "80px", 'dataField': "mrp", visible: CONTEXT.ENABLE_MRP },
                ...
                page.controls.grdReturnPOItems.rowBound = function (row, item) {
                    ...
                    //var discount = (item.ret_qty * item.buying_cost) * parseFloat(item.disc_per) / 100 + ((parseFloat(item.disc_val) * parseFloat(item.ret_qty)));
                    //item.buying_cost = parseFloat((parseFloat(price) - parseFloat(discount)) / parseFloat(item.qty)).toFixed(5);
                    ...
                    $(row).find("[id=itemUnit]").change(function () {
                        ...
                        txtAmount.html(parseFloat(paidAmt).toFixed(5));
                    });
            ...
            selectedPendingPayment: function (data) {
                ...
                $$("grdPendingPayment").setTemplate({
                    selection: "Single",
                    columns: [
                        { 'name': "PO No", 'rlabel': 'PO No', 'width': "80px", 'dataField': "po_no" },
                        { 'name': "Bill No", 'rlabel': 'Bill No', 'width': "80px", 'dataField': "bill_no" },
                        { 'name': "Bill Date", 'rlabel': 'Bill Date', 'width': "80px", 'dataField': "bill_date" },
                        { 'name': "Total Amount", 'rlabel': 'Total Amount', 'width': "120px", 'dataField': "total" },
                        { 'name': "Paid", 'rlabel': 'Paid', 'width': "120px", 'dataField': "total_paid_amount" },
        ...
        page.events = {
            ...
            btnAddPOOK_click: function () {
                ...
                page.maximumIdAPI.getValue(data, function (id) {
                            ...
                            page.stockAPI.insertBill(newBill, function (data) {
                                ...
                                if (CONTEXT.ENABLE_FINFACTS_MODULES == true) {
                                    ...
                                    var data1 = {
                                        ...
                                        tax_amt: parseFloat(page.controls.lblTotalTax.value()).toFixed(5),
            ...
            btnAddToStockConfirm_click: function (free) {
                ...
                try {
                    ...
                    $(page.controls.grdPOItems.allData()).each(function (i, item) {
                        ...
                        //    item.qty_delivered = parseFloat(item.qty_delivered) * parseFloat(item.alter_unit_fact);
                        //    item.qty_instock = parseFloat(item.qty_instock) * parseFloat(item.alter_unit_fact);
                        //    item.qty_infreestock = parseFloat(item.qty_infreestock) * parseFloat(item.alter_unit_fact);
                        //    item.temp_qty = parseFloat(item.temp_qty) * parseFloat(item.alter_unit_fact);
                        //    item.temp_free_qty = parseFloat(item.temp_free_qty) * parseFloat(item.alter_unit_fact);
                        ...
                        if (item.qty_tostock > 0) {
                            ...
                            inventItems.push({
                                ...
                                store_no: getCookie("user_store_id"),
                                item_no: item.item_no,
                                cost: free == "true" ? "0" : parseFloat(item.buying_cost).toFixed(5),
                            ...
                            if (CONTEXT.ENABLE_EXP_DATE) {
                                if (item.expiry_date == undefined || item.expiry_date == null || item.expiry_date == "" || item.expiry_date == "--") { }
                                    ...
                                    inventItems[inventItems.length - 1].expiry_date = item.expiry_date;
                                }
                            }
                            if (CONTEXT.ENABLE_MAN_DATE) {
                                if (item.man_date == undefined || item.man_date == null || item.man_date == "" || item.man_date == "--") { }
                                else {
                                    inventItems[inventItems.length - 1].man_date = item.man_date;
                                }
                            }
                        }
                    });
                ...
                try {
                    ...
                    $(itemlList).each(function (i, item) {
                        ...
                        if (parseFloat(item.ret_qty) > 0) {
                            ...
                            buying_cost = buying_cost + parseFloat(parseFloat(item.ret_qty) * parseFloat(item.buying_cost)).toFixed(5);
                            ...
                            if (typeof overrideItems != "undefined") {
                                ...
                                var round_off = parseFloat(parseFloat(newBill.total) - parseFloat(total_after_Rnd_off)).toFixed(5);
                            ...
                            page.purchaseService.updatePOItems(0, items, function () {
                                page.stockAPI.insertAllStockVar(0, inventItems, function (data) {
                                    ...
                                    var data1 = {
                                        ...
                                        buying_cost: parseFloat(buying_cost).toFixed(5),
                ...
                $$("grdPOResult").dataBind({
                    getData: function (start, end, sortExpression, filterExpression, callback) {
                        page.purchaseService.getPOs("", "", page.view.searchInput(), $$("ddlState").selectedValue(), function (data) {
                            ...
                            page.purchaseService.getPOs(start, end, page.view.searchInput(), $$("ddlState").selectedValue(), function (data) {
            ...
            btnInvoicePO_click: function () {
                ...
                page.controls.pnlInvoicePOPopup.width(300);
            ...
            page_load: function () {
                ...
                $$("ddlState").selectionChange(function () {
                    ...
                    $$("grdPOResult").dataBind({
                        getData: function (start, end, sortExpression, filterExpression, callback) {
                            page.purchaseService.getPOs("", "", page.view.searchInput(), state, function (data) {
                                var totalRecord = data.length;
                                page.purchaseService.getPOs(start, end, page.view.searchInput(), state, function (data) {
                                    callback(data, totalRecord);
                                });
                            });
                        },
                ...
                $$("grdPOResult").dataBind({
                    getData: function (start, end, sortExpression, filterExpression, callback) {
                        page.purchaseService.getPOs("", "", page.view.searchInput(), -1, function (data) {
                            var totalRecord = data.length;
                            page.purchaseService.getPOs(start, end, page.view.searchInput(), -1, function (data) {
                                callback(data, totalRecord);
                            });
                        });
                    },
