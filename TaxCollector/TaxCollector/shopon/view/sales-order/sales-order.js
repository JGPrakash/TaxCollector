$.fn.salesOrder = function () {
    return $.pageController.getPage(this, function (page, $$) {
        ...
        page.printJasper = function (bill_no, exp_type) {
            ...
            //        page.events.btnprintInvoiceTemplate1_click(data, exp_type);
            //    });
            //}
            //if (CONTEXT.SALES_ORDER_PRINT == "Template2") {
        ...
        page.events.btnprintInvoiceTemplate2_click = function (billItem, exp_type) {
            ...
            $(billItem.bill_items).each(function (i, item) {
                ...
                bill_item.push({
                    ...
                    "Pack": "Pcs",	// nonstandard single-quoted field name
                    "Batch": "Pcs",	// standard double-quoted field name
                    "Exp": "Pcs",
                    "Qty": item.qty,
                    ...
                    "GST Amt": (data.state_text == "Return")?parseFloat(parseFloat(parseFloat(item.total_price)*parseFloat(item.tax_per)/100)).toFixed(2):parseFloat(parseFloat(item.total_price).toFixed(2) - parseFloat(item.item_sub_total).toFixed(2) + parseFloat(item.discount).toFixed(2)).toFixed(2),
                    "GValue": parseFloat(item.total_price).toFixed(2)
                });
            });
            data.address1 = data.address.substring(0, data.address.length / 2);
            data.address2 = data.address.substring(data.address.length / 2, data.address.length);
            var accountInfo =
                {
                    "BillType": "",
                    ...
                    "GST Amt": parseFloat(data.tax).toFixed(2),
                    ...
                    "CompanyPhoneNoEtc": "8825530028",//CONTEXT.COMPANY_PHONE_NO,
            ...
            if (page.PrintBillType == "SaleReturn") {
                ...
                GeneratePrint("ShopOnDev", "sales-bill-print/main_sales_template14.jrxml", accountInfo, exp_type, function (responseData) {
                ...
                GeneratePrint("ShopOnDev", "sales-bill-print/blackcurrant-sales-bill.jrxml", accountInfo, exp_type, function (responseData) {
                   // $$("pnlPrintingPopup").close();
                    $$("pnlBillViewPopup").open();
                    $$("pnlBillViewPopup").title("Bill View");
                    $$("pnlBillViewPopup").rlabel("Bill View");
            ...
            var accountInfo =
                        {
                            ...
                            "GST Amt": parseFloat(data.tot_tax_amt).toFixed(2),
                            "BillAmount": parseFloat(data.total).toFixed(2),
                            "AdvanceAmount": advance_pay,
                            "CurrentAmount": current_pay,
                            "PaidAmount": parseFloat(paid).toFixed(2),
        ...
        page.view = {
            ...
            searchResult: function (data) {
                ...
                page.controls.grdSOResult.setTemplate({
                    ...
                    columns: [
                        { 'name': "ID", 'width': "60px", 'dataField': "order_id" },
                        { 'name': "ID", 'width': "60px", 'dataField': "order_no", visible: false },
