$.fn.settingsPage = function () {
    return $.pageController.getPage(this, function (page, $$) {
        ...
        page.events.btnUploadGen_click = function () {
            ...
            page.settingApi.searchSettings("", "", "value_2='General' and sett_key='LAST_UPLOAD_TIME' and comp_id = " + getCookie("user_company_id"), "sett_no", function (data) {
                if (data.length > 0) {
                    var upData = {
        ...
        page.events.btnDownloadGen_click = function () {
            page.settingApi.searchSettings("", "", "value_2='General' and sett_key='LAST_DOWNLOAD_TIME' and comp_id = " + getCookie("user_company_id"), "sett_no", function (data) {
                if (data.length > 0) {
                    var upData = {
                        upd_date: data[0].value_1,
                        s_comp_id: localStorage.getItem("user_company_id"),
                        s_store_no: localStorage.getItem("user_store_no"),
                        s_auth_token: getCookie("auth_token")
                    }
                    $.server.webMethodPOST("eshopon/shopon/online-offline-sync/online", upData, function (data) {
