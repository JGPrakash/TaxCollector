            ...
            btnUploadImage_click: function () {
                ...
                if (files.length > 0) {
                    ...
                    var ajaxRequest = $.ajax({
                        ...
                        headers: {
                            'file-path': CONTEXT.ENABLE_IMAGE_FILE_PATH + $$("lblItemNo").value() + '\\'//CONTEXT.ENABLE_IMAGE_FILE_PATH + $$("lblItemNo").value() + '/'
                        },
                        contentType: false,
                        processData: false,
                        data: data
                    ...
                    /*sssvar data = {
                        source_location: "F:\\Jebas\\Photos\\Grocery_Shop\\Downloaded\\" + files[0].name,
                        destination_location: "F:\\Project\\Jebas_Project\\ShopOn\\UploadImages\\Delivery_App\\" + $$("lblItemNo").value()+"\\"//CONTEXT.ENABLE_IMAGE_FILE_PATH + $$("lblItemNo").value() + '/'
                    }
                    page.itemAPI.postImageValue(data, function (data) {
