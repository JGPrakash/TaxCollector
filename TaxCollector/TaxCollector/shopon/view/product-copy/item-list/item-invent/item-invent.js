    ...
    return $.pageController.getControl(this, function(page, $$) {
        ...
        page.events.btnItemVariationSave_click = function () {
            ...
            $($$("grdItemVariation").selectedData()).each(function (i, item) {
                if (data.var_attr1 == "")
                    data.var_attr1 = item.attr_no;
                else
                    data.var_attr1 = data.var_attr1 + "-" + item.attr_no;
            });
        ...
        page.interface.load = function(itemNo,exp_days) {
            ...
            page.itemAPI.getValue(itemNo, function (variation_data) {
                ...
                if (variation_data[0].var_attr1 != null && variation_data[0].var_attr1 != "" && typeof variation_data[0].var_attr1 != "undefined")
                    page.item_attr_list = variation_data[0].var_attr1.split("-");
                page.stockAPI.searchStocksMain(page.item_no, localStorage.getItem("user_store_no"), function (data) {
                    //page.controls.grdItemInventory.dataBind(data);
                    page.view.selectedItemInventory(data);
                    page.stockAPI.searchVariationsMain (page.item_no, localStorage.getItem("user_store_no"), function (data1) {
            ...
            selectedItemVariation: function (data) {
                ...
                page.controls.grdItemVariations.setTemplate({
                    ...
                    columns: [
                        ...
                        { 'name': getAttributeName(1), 'rlabel': getAttributeName(1), 'width': "100px", 'dataField': "cost", visible: page.item_attr_list.includes("1") },
                        { 'name': "Qty", 'rlabel': 'Qty', 'width': "80px", 'dataField': "qty" },
                        { 'name': getAttributeName(2), 'rlabel': getAttributeName(2), 'width': "60px", 'dataField': "mrp", visible: page.item_attr_list.includes("2") },
                        { 'name': getAttributeName(3), 'rlabel': getAttributeName(3), 'width': "70px", 'dataField': "batch_no", visible: page.item_attr_list.includes("3") },
                        { 'name': getAttributeName(4), 'rlabel': getAttributeName(4), 'width': "90px", 'dataField': "expiry_date", visible: page.item_attr_list.includes("4") },
                        { 'name': getAttributeName(5), 'rlabel': getAttributeName(5), 'width': "150px", 'dataField': "man_date", visible: page.item_attr_list.includes("5") },
                        { 'name': getAttributeName(6), 'rlabel': getAttributeName(6), 'width': "120px", 'dataField': "vendor_name", visible: page.item_attr_list.includes("6") },
                        { 'name': getAttributeName(7), 'rlabel': getAttributeName(7), 'width': "90px", 'dataField': "invoice_no", visible: page.item_attr_list.includes("7") },
                        { 'name': getAttributeName(8), 'rlabel': getAttributeName(8), 'width': "90px", 'dataField': "size", visible: page.item_attr_list.includes("8") },
