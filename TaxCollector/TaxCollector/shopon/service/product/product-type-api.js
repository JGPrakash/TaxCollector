function ProductTypeAPI() {
    ...
    this.getValue = function (id, callback) {
        $.server.webMethodGET("shopon/producttype/" + id.ptype_no + "?ptype_no=" + id.ptype_no, callback, callback);
    }

    this.postValue = function (data, callback, errorCallback) {
        $.server.webMethodPOST("shopon/producttype/", data, callback, errorCallback);
    }

    this.putValue = function (id, data, callback, errorCallback) {
        $.server.webMethodPUT("shopon/producttype/" + id, data, callback, errorCallback);
    }

    this.deleteValue = function (id, data, callback, errorCallback) {
        $.server.webMethodDELETE("shopon/producttype/" + id, data, callback, callback, callback);
    }
}