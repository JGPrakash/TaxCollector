function SalesExecutiveService() {
    ...
    this.getTotalPoint = function (data, callback) {
        var map = new Map();
        map.add("sale_executive_no", data);
        map.add("comp_id", getCookie("user_company_id"));
        $.server.webMethod("SalesExecutive.getTotalPoint", map.toString(), callback);
    }


    this.updateBarcode = function (data, callback) {
        var map = new Map();
        map.add("sale_executive_no", data.sale_executive_no);
        map.add("sales_executive_barcode", data.sales_executive_barcode);
        map.add("comp_id", getCookie("user_company_id"));
        $.server.webMethod("SalesExecutive.updateBarcode", map.toString(), callback);
    }
}