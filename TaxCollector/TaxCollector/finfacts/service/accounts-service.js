...
function AccountsService()
{
    this.getAccounts = function (callback) {
        ...
        $.server.webMethod("FinFacts.NewAccount.getAllAccounts", map.toString(), callback);
    };
    ...
    this.insertAccount = function (data, callback) {
        ...
        $.server.webMethod("FinFacts.NewAccount.getAllNewAccount", map.toString(), callback);
    };
    ...
    $.server.webMethod("FinFacts.NewAccount.getAllUpdate", map.toString(), callback);
    ...
    this.deleteAccount = function (acct_id, callback) {
      var map = new Map();
       ...
       $.server.webMethod("FinFacts.NewAccount.deleteAccount", map.toString(), callback);
    };
    
    this.getAccountByNamePhone = function (term, callback) {
      
      $.server.webMethod("FinFacts.NewAccount.getAccountByNamePhone", "term;%" + term + "%", callback);
    };
    
    this.getContactByName = function (cont_fname, callback) {
      
      $.server.webMethod("FinFacts.NewAccount.getContactByName", "cont_fname;" + cont_fname, callback);
    };
    
    this.getContforAct = function (acct_id,callback) {
        var map = new Map();
           map.add("acct_id",acct_id);
        $.server.webMethod("FinFacts.NewAccount.getContforAct", map.toString(), callback);
    };
    
    this.getContactById = function (acct_id, callback) {
        
        $.server.webMethod("FinFacts.NewAccount.getContactById", "acct_id;" + acct_id, callback);
    };
    ...
    this.insertContAct = function (data, callback) {
      ...
      $.server.webMethod("FinFacts.NewAccount.insertContAct", map.toString(), callback);
    };
    this.deleteContAct = function (acct_id, callback) {
      var map = new Map();
        map.add("acct_id",acct_id);
       $.server.webMethod("FinFacts.NewAccount.deleteContAct", map.toString(), callback);
    };
}
